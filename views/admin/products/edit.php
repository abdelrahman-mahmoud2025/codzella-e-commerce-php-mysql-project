<h1 class="text-3xl font-bold text-gray-800 dark:text-gray-100 mt-8 mb-6 text-center">Edit Product</h1>

<div class="max-w-3xl mx-auto my-6">
    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-md p-6">
        <form method="POST" action="<?php echo APP_URL; ?>/admin/editProduct/<?php echo $product['id']; ?>" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea name="description" id="description" rows="5"
                    class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500"><?php echo htmlspecialchars($product['description']); ?></textarea>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                    ...
                    <input type="number" name="sale_price" id="sale_price" step="0.01" min="0" value="<?php echo $product['sale_price']; ?>"
                        class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200 focus:outline-none focus:ring-emerald-500 focus:border-emerald-500">
                </div>
            </div>
            ...
            <div class="mb-4">
                <label class="block text-gray-700 dark:text-gray-200 font-medium mb-1">Product Image</label>
                <?php if ($product['image']): ?>
                    <div class="mb-2">
                        <img src="<?php echo APP_URL; ?>/uploads/<?php echo $product['image']; ?>" alt="" class="max-w-xs rounded-md border border-gray-200 dark:border-gray-700">
                    </div>
                <?php endif; ?>
            ...
            <div class="mb-4 flex gap-6">
                <label class="flex items-center gap-2 text-gray-700 dark:text-gray-200">
                    <input type="checkbox" name="is_featured" value="1" <?php echo $product['is_featured'] ? 'checked' : ''; ?> class="form-checkbox">
                    Featured Product
                </label>
                <label class="flex items-center gap-2 text-gray-700 dark:text-gray-200">
                    <input type="checkbox" name="is_active" value="1" <?php echo $product['is_active'] ? 'checked' : ''; ?> class="form-checkbox">
                    Active
                </label>
            </div>

            <div class="flex gap-4 mt-6">
                <button type="submit" class="px-6 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white rounded-lg font-medium transition">Update Product</button>
